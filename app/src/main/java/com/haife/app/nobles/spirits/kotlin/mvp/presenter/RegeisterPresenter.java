 ...
 */
@ActivityScope
public class RegeisterPresenter extends BasePresenter<RegeisterContract.Model, RegeisterContract.View> {
    @Inject
    ...
    @Inject
    public RegeisterPresenter(RegeisterContract.Model model, RegeisterContract.View rootView) {
