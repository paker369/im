 ...
 */
@ActivityScope
public class FriendAskListModel extends BaseModel implements FriendAskListContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public FriendAskListModel(IRepositoryManager repositoryManager) {
