 ...
 */
@ActivityScope
public class EditMyGroupCardModel extends BaseModel implements EditMyGroupCardContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public EditMyGroupCardModel(IRepositoryManager repositoryManager) {
