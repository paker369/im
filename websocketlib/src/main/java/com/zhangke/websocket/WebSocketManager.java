...
public class WebSocketManager {
    ...
    public boolean isConnecting() {
        return mWebSocket != null && mWebSocket.getConnectState() == 1;
    }
    ...
    public boolean needReConnect() {
        return mWebSocket != null && mWebSocket.getConnectState() == 0;
    }
     ...
     * 移除一个监听器
     */
    public WebSocketManager removeAllListener() {
        mDelivery.clear();
        return this;
    }
    ...
    void reconnectOnce() {
        ...
        if (mWebSocket.getConnectState() == 0) {
            ...
            LogUtil.e(TAG, "WebSocket 已连接，请勿重试。"+mSetting.getConnectUrl());
        }
    }
    ...
    private ReconnectManager getDefaultReconnectManager() {
        return new DefaultReconnectManager(this, new ReconnectManager.OnConnectListener() {
            ...
            @Override
            public void onConnecting(int count) {
            ...
            public void onDisconnect() {
                LogUtil.i(TAG, "重连失败");
                if(mSetting.getResponseDispatcher()!=null&&mDelivery!=null){
