...
public class UpdateDialog extends Dialog implements View.OnClickListener, OnDownloadListener {
    ...
    private OnButtonClickListener buttonClickListener1;
    ...
    private void init(Context context) {
        ...
        buttonClickListener1 = configuration.getOnButtonClickListener1();
    ...
    private void initView(View view) {
        ...
        progressBar.setReachedBarHeight(30);
        progressBar.setUnreachedBarHeight(30);
        update = view.findViewById(R.id.btn_update);
//        updateOut = view.findViewById(R.id.btn_updateOut);
        update.setTag(0);
//        updateOut.setTag(0);
        View line = view.findViewById(R.id.line);
        update.setOnClickListener(this);
//        updateOut.setOnClickListener(this);
...
//            updateOut.setVisibility(View.GONE);
