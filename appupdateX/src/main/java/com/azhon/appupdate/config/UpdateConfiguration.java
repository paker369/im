...
public class UpdateConfiguration {
     ...
     * 按钮点击事件回调
     */
    private OnButtonClickListener onButtonClickListener1;
    /**
     ...
     * 设置内置对话框按钮点击事件监听
     */
    public UpdateConfiguration setButtonClickListener1(OnButtonClickListener onButtonClickListener) {
        this.onButtonClickListener1 = onButtonClickListener;
        return this;
    }
     ...
     * 获取内置对话框按钮点击事件监听
     */
    public OnButtonClickListener getOnButtonClickListener1() {
        return onButtonClickListener1;
    }
